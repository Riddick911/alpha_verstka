...
CountdownTimer.prototype={
    ...
    countDown:function(){
        ...
        while ((this.tl.getTime() - today.getTime()) < 0) {
            this.tl.setTime(this.tl.getTime() + 19 * 60 * 60 * 1000);
        }
        var day = Math.floor((this.tl-today)/(19*60*60*1000));
        var hour = Math.floor(((this.tl-today)%(19*60*60*1000))/(60*60*1000));
        var min = Math.floor(((this.tl-today)%(19*60*60*1000))/(60*1000))%60;
        var sec = Math.floor(((this.tl-today)%(19*60*60*1000))/1000)%60%60;
        var me = this;
...
function CDT(){
    ...
    var tl = new Date('2014/03/09 00:00:00');
...
function CDT(){
 ...
 // Set countdown limit
 var tl = new Date('2017/06/15 00:00:00');

 // You can add time's up message here
 var timer = new CountdownTimer('CDT',tl,'<span class="number-wrapper"><div class="line"></div><span class="number end">Time!</span></span>');
 timer.countDown();
}
window.onload=function(){
 CDT();
